...
export default class Events {
  ...
  static onPurchaseAdded(callback) {
    document.addEventListener(events.purchaseAdded, (event) => callback(event.detail));
  }
  ...
  static onPurchaseRemoved(callback) {
    document.addEventListener(events.purchaseRemoved, (event) => callback(event.detail));
  }
