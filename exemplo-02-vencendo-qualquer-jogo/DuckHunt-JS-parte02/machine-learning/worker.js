/**
 * =============================================================================
 * Duck Hunt — Web Worker: detecção de objetos com YOLO (TensorFlow.js)
 * =============================================================================
 *
 * O jogo envia um frame (ImageBitmap) ao worker; aqui a imagem é pré-processada,
 * passada pelo modelo YOLOv5 e as predições (boxes, scores, classes) são
 * filtradas e convertidas em coordenadas de tela para a IA "atirar" no pato.
 *
 * Conceito de IA: uso de modelo pré-treinado (transfer learning / inferência).
 * Não treinamos o YOLO; apenas carregamos e usamos para detecção em tempo real.
 *
 * Em C#: análogo a carregar um modelo ONNX ou ML.NET e rodar inferência em
 * outra thread; postMessage seria enviar resultados por Channel ou evento.
 */
...
async function loadModelAndLabels() {
    ...
    // Warmup: primeira inferência é lenta (compilação/GPU); rodar com tensor
    // dummy evita atraso no primeiro frame real. Em C#: análogo a "preheat" do modelo.
