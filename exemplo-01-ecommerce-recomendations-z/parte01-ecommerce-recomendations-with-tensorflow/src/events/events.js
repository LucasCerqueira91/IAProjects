/**
 * =============================================================================
 * Events — Barramento de eventos (Pub/Sub) via CustomEvent no document
 * =============================================================================
 *
 * Padrão: quem dispara chama dispatch*(data); quem escuta chama on*(callback).
 * O callback recebe event.detail com o payload. Isso desacopla controllers
 * e views: nenhum precisa referenciar o worker ou o outro controller.
 *
 * Em C#: equivalente a um IEventAggregator ou MediatR (publish/subscribe)
 * com eventos nomeados. CustomEvent + document é o "event bus" nativo do browser.
 */
